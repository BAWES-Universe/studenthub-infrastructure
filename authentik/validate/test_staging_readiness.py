...
CASES = [
    ...
    (
        ...
        "OIDC_CALLBACK_URL=https://staging.studenthub.co/oauth/callback",
        "/login/callback",
    ),
    (
        ...
        "OIDC_TOKEN_URL=http://auth.bawes.net/application/o/token/",
        "must use https",
    ),
    (
